...
export class ProjectsdataService {
    ...
    projects = [
        {
            title: 'Join',
            aboutDe: 'Join ist ein Task-Managementsystem inspiriert vom Kanban-System. Es können Aufgaben erstellt, bearbeitet, organisiert und gelöscht werden. Dafür gibt es eine Drag- and Drop-Funktion und User und Kategorien können zugeordnet werden. Außerdem können User sich ein eigenes Profil anlegen.',
            aboutEn: 'Join is a task management system inspired by the Kanban method. Tasks can be created, edited, organized, and deleted. It features a drag-and-drop function, and users and categories can be assigned to tasks. Additionally, users can create their own profile.',
            durationWeeks: '6',
        ...
        {
            title: 'Dusky Swamps',
            aboutDe: 'Dusky Swamps ist ein kleines Jump-an-Run Spiel mit Fokus auf objekt-orientierte Programmierung. Als Astronaut besiegt man die Monster des Sumpfes, sammelt Edelsteine und kämpft gegen einen Endboss.',
